    ...
    <div>
      ...
      <div className="midOne">
        ...
        <div>
          ...
          <p className="textPhotoStyle" >
            Our telented team of recruiters can help you find the best
            freelancers for the job and our technical co-pilots can even manage
            the project for you.
          </p>
        </div>
      </div>
      ...
      <div className="midTwo">
        <div>
          ...
          <p className="textPhotoStyle1 text1">
              ...
              browsing their samples of previous
              work and reading their profile
              reviews.
          </p>
        </div>
        <div>
          ...
          <p className="textPhotoStyle2">
            Freelancer.com has by far the largest
            pool of quality freelancers globally-over
            50 million to choose from.
          </p>
        </div>
      </div>
    <hr/>
